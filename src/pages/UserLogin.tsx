        ...
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <form className="w-2/6 mx-auto bg-white px-32 py-24 shadow-md rounded-lg" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col items-start mb-5">
                    ...
                    <label htmlFor="terms" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Not a User? <Link to="/userregistration" className="text-red-600 hover:underline dark:text-red-700">Donor Registration</Link></label>
